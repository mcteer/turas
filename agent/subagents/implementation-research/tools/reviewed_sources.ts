...
const sources = [
  ...
  { id: "src-eve-hitl", title: "eve Human-in-the-Loop documentation", publisher: "Vercel", url: "https://github.com/vercel/eve/blob/main/docs/tools/human-in-the-loop.md", sourceType: "primary technical documentation", retrievedAt: "2026-09-19", supports: "Approval-gated actions pause and resume durably." },
];
