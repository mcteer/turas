...
export default defineConfig({
  ...
  webServer: process.env.PLAYWRIGHT_BASE_URL ? undefined : {
    ...
    env: {
      ...
      PANEL_USERNAME: "playwright-panel",
      PANEL_PASSWORD: "playwright-panel-password",
      TURAS_DEMO_REVIEWER_USERNAME: "playwright-legacy-reviewer",
      TURAS_DEMO_REVIEWER_PASSWORD: "playwright-legacy-password",
