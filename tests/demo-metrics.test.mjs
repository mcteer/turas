...
const notion = { fee: 60000, actualHours: 240, remainingHours: 80, loadedHourlyCost: 125, nonLaborCost: 3000 };

test("synthetic intervention anchor reconciles contribution", () => {
  assert.deepEqual(engagementMetrics(notion), {
  ...
  const intervention = engagementMetrics(notion, { remainingHours: 40 });
